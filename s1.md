&#9664; [ANTERIOR](https://github.com/mauricioge/ia-desarrollo/blob/main/README.md)
...
## 1.1 Consultar la ruta a seguir y exigir justificación 🛣️
✅ **QUÉ HACER:**\
...
## 1.4 Identificar riesgos y supuestos antes de codificar ⚠️
✅ **QUÉ HACER:**\
...
## 1.7 Estimación de tiempos con margen para imprevistos (PERT) ⏱️
...
[SIGUIENTE](https://github.com/mauricioge/ia-desarrollo/blob/main/s2.md) &#9654;
